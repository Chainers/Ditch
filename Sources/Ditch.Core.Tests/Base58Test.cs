...
namespace Ditch.Core.Tests
{
    ...
    {
        [Test]
        [TestCase("02e649f63f8e8121345fd7f47d0d185a3ccaa843115cd2e9392dcd9b82263bc680", "KwKM6S22ZZDYw5dxBFhaRyFtcuWjaoxqDDfyCcBYSevnjdfm9Cjo")]
        [TestCase("021c7359cd885c0e319924d97e3980206ad64387aff54908241125b3a88b55ca16", "KwHpCk3sLE6VykHymAEyTMRznQ1Uh5ukvFfyDWpGToT7Hf5jzrie")]
        [TestCase("02f561e0b57a552df3fa1df2d87a906b7a9fc33a83d5d15fa68a644ecb0806b49a", "KwKTjyQbKe6mfrtsf4TFMtqAf5as5bSp526s341PQEQvq5ZzEo5W")]
        [TestCase("03e7595c3e6b58f907bee951dc29796f3757307e700ecf3d09307a0cc4a564eba3", "KwMJJgtyBxQ9FEvUCzJmvr8tXxB3zNWhkn14mWMCTGSMt5GwGLgz")]
        [TestCase("02b52e04a0acfe611a4b6963462aca94b6ae02b24e321eda86507661901adb49", "5HqUkGuo62BfcJU5vNhTXKJRXuUi9QSE6jp8C3uBJ2BVHtB8WSd")]
        [TestCase("5b921f7051be5e13e177a0253229903c40493df410ae04f4a450c85568f19131", "5JWcdkhL3w4RkVPcZMdJsjos22yB5cSkPExerktvKnRNZR5gx1S")]
        [TestCase("0e1bfc9024d1f55a7855dc690e45b2e089d2d825a4671a3c3c7e4ea4e74ec00e", "5HvVz6XMx84aC5KaaBbwYrRLvWE46cH6zVnv4827SBPLorg76oq")]
        [TestCase("6e5cc4653d46e690c709ed9e0570a2c75a286ad7c1bc69a648aae6855d919d3e", "5Jete5oFNjjk3aUMkKuxgAXsp7ZyhgJbYNiNjHLvq5xzXkiqw7R")]
        [TestCase("b84abd64d66ee1dd614230ebbe9d9c6d66d78d93927c395196666762e9ad69d8", "5KDT58ksNsVKjYShG4Ls5ZtredybSxzmKec8juj7CojZj6LPRF7")]
        public void Base58CheckDecodeTest(string key, string value)
        {
            ...
            Assert.IsTrue(key.Equals(testrez));
        }
        ...
        public void Base58CheckEncodeTest(string key, string value)
        {
            ...
            Assert.IsTrue(value.Equals(rez));
        }
        ...
        [Test]
        [TestCase("029b458cb5ebb3766fe6bcd993bbf707112a53862d2eb4404c5108d75e4c64560c", "STM", "STM64sZSzJgW9wj44BQG3YyiMY7Z6pDeTNhm4n2xux87iZzVLNXHG")]
        public void EncodePublicWifTest(string key, string prefix, string expected)
        {
            ...
            Assert.IsTrue(expected.Equals(wif));
        }

        [Test]
        [TestCase("STM64sZSzJgW9wj44BQG3YyiMY7Z6pDeTNhm4n2xux87iZzVLNXHG", "STM", "029b458cb5ebb3766fe6bcd993bbf707112a53862d2eb4404c5108d75e4c64560c")]
        public void DecodePublicWifTest(string key, string prefix, string expected)
        {
            ...
            Assert.IsTrue(expected.Equals(hex));
        }


        [Test]
        [TestCase("5JSMFNCV2rciddgrAtNs23Q2iCP7VuhDYFVQ4NppTVT1bzoNtZN", "STM5SLu1JSgYJDPTszgm9xqPDvo3NSRC64gYyirPnQTsDQ38Pg7WC")]
        public void GetPublicKeyTest(string privateKey, string expectedPubKey)
        {
            ...
            Assert.IsTrue(expectedPubKey.Equals(pWif));
        }
