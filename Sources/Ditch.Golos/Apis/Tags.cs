...
namespace Ditch.Golos
{
    ...
    public partial class OperationManager
    {
        ...
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByTrendingAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_trending", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByCreatedAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_created", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByActiveAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_active", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByCashoutAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_cashout", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByVotesAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_votes", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByHotAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_hot", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByFeedAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_feed", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByBlogAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_blog", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByCommentsAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_comments", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByPromotedAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_promoted", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<Discussion[]>> GetDiscussionsByChildrenAsync(DiscussionQuery query, CancellationToken token)
        {
            return CustomGetRequestAsync<Discussion[]>(KnownApiNames.Tags, "get_discussions_by_children", new object[] { query }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<TagApiObj[]>> GetTrendingTagsAsync(string afterTag, uint limit, CancellationToken token)
        {
            return CustomGetRequestAsync<TagApiObj[]>(KnownApiNames.Tags, "get_trending_tags", new object[] { afterTag, limit }, token);
        }
        ...
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<MapContainer<string, uint>>> GetTagsUsedByAuthorAsync(string author, CancellationToken token)
        {
            return CustomGetRequestAsync<MapContainer<string, uint>>(KnownApiNames.Tags, "get_tags_used_by_author", new object[] { author }, token);
        }
        ...
        /// <returns>API type: discussion  Vector of discussions sorted by children posts amount</returns>
        /// <exception cref="T:System.OperationCanceledException">The token has had cancellation requested.</exception>
        public Task<JsonRpcResponse<JObject>> GetLanguagesAsync(CancellationToken token)
        {
            return CustomGetRequestAsync<JObject>(KnownApiNames.Tags, "get_languages", token);
        }
    }
}