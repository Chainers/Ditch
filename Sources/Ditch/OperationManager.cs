...
namespace Ditch {
   public class OperationManager {
      ...
      private static JsonSerializerSettings GetSerializerSettings() {
         ...
         serializerSettings.DateFormatString = "yyyy'-'MM'-'dd'T'HH':'mm':'ss.FFFFFFF";
      ...
      public OperationManager(string url, byte[] chainId) : this(url, chainId, GetSerializerSettings()) {
      }
