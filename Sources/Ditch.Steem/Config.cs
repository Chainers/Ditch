...
namespace Ditch.Steem
{
    ...
    public class Config
    {
        ...
        public const UInt32 SteemAssetNumSbd = 0x5f5e1003;// ((SmtMaxNai + SteemNaiSbd) << SteemAssetSymbolPrecisionBits) | SteemPrecisionSbd;
        public const UInt32 SteemAssetNumSteem = 0x5f5e1013;//((SmtMaxNai + SteemNaiSteem) << SteemAssetSymbolPrecisionBits) | SteemPrecisionSteem;
        public const UInt32 SteemAssetNumVests = 0x5f5e1026;//((SmtMaxNai + SteemNaiVests) << SteemAssetSymbolPrecisionBits) | SteemPrecisionVests;
        ...
        public const UInt64 SteemSymbolSer = 0x00004d4545545303; //((UInt64)3 | (SteemSymbolU64 << 8)); // < STEEM|TESTS with 3 digits of precision;
        public const UInt64 SbdSymbolSer = 0x0000000044425303; //((UInt64)3 | (SbdSymbolU64 << 8));     // < SBD|TBD with 3 digits of precision;
